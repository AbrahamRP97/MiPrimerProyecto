  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.form}>
        <CustomInput label="Nombre" value={nombre} onChange={setNombre} type="text" required={false} />
        <CustomInput label="Correo" value={correo} onChange={setCorreo} type="email" required={false} />
        <CustomInput label="Teléfono" value={telefono} onChange={setTelefono} type="number" required={false} />
